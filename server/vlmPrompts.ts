...
DOMAIN HIERARCHY (every card has all four tiers \u2014 do not collapse them):
  ...
  4. parallel   = the variant/finish of an individual card. Common parallel names include: Refractor, Mojo, X-Fractor, Gold Refractor, Pink Refractor, Sparkle Refractor, Disco, Red Sparkle, Tie-Dye, Blue Wave, Red Prizm, Silver Prizm, White Sparkle, Pink Ice, Prizmatic, Zebra, Black White Checker, Emergent Green Ice, Green Scope, Neon Green Pulsar, Purple Shock, Blue Hyper, Green Hyper, Red Pandora, Mythical, Holo (Donruss Optic), Lazer, Blue Glitter, Red White Blue (Mosaic), Honeycomb, Genesis, Pink Camo, Color Blast, Visionary, Green Shock, Red Yellow, Blue Prizm, Cracked Ice, Press Proof, Orange Laser, Red Ice, Blue Sparkle, Kaboom, Blue, Diamante, Gold, Holiday Green Leaf, Holo Foil, Holo Foil Pink, Rainbow Foilboard, Silver Cracked Foilboard, Cubic, Gold Cracked Ice, Holo Web, Rainbow Foil, Hyper, Shattered, Slime, etc. Use one of these names verbatim when the visible finish matches; otherwise emit a clean human-readable name describing the finish.
