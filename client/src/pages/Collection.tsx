    ...
    >
      ...
      <div className="p-2.5">
        ...
        <p className="text-[11px] text-muted-foreground truncate">
          {displayYear(card.year, sportName(card), (card as any).yearPrintedRaw) ?? card.year} {brandName(card) || "Unknown brand"}
        </p>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[11px] text-muted-foreground truncate">
          {displayYear(card.year, sportName(card), (card as any).yearPrintedRaw) ?? card.year} {brandName(card)} · {parallelLabel(card)}
        </p>
      </div>
